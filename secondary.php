...
<head>
    ...
    <link rel="stylesheet" href="./secondProjectOjt/css folder/secondary.css">
...
<body>
   ...
   <div class="whole_school_ctn">
        ...
        <div class="techl_ctn_secondary">
            <h1>Mr.Andrew</h1>
            <div class="techl_info_secondary"></div>
        </div>
        <div class="subject_ctn_secondary">
            <h1>Mathematic</h1>
            <div class="subject_info_secondary"></div>
        </div>
         ...
         <div class="learn_method">
                ...
                <div class="whole_ctn">
                    ...
                    <div class="virtual_class">
                        <div class="virtual_image_ctn_secondary">
                    ...
                    <div class="online_class">
                          <div class="online_image_ctn_secondary">
