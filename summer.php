...
<body>
    ...
    <!-- navbar section end -->
    <!-- intro summer section start -->
    <h1 class="intro_summer">Welcome to Program Summer</h1>
    <!-- intro summer section end -->
    ...
    <script src="./secondProjectOjt/javascript/summer.js"></script>
